...
system proposal to which we started. The low-level orchestration handle
...
some troubles with some components. In fact, we choose to deploy our platform on
Kubernetes but we were not able to make Openbaton and this container
