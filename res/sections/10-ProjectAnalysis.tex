...
its feasibility. We calculated at least six months necessary to be able to
create a working proof of concept (PoC) that allowed us to perform tests and, in
