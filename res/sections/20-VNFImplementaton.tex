...
latency. On the other hand it is unreliable and congestion scenarios are not
managed.
...
\begin{figure}
  \centering \includegraphics[scale=0.38]{ingress_seq_diagram}
...
\begin{figure}
  \centering \includegraphics[scale=0.38]{egress_seq_diagram}
