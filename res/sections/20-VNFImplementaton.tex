...
operation. It is implemented in Java using Spark to expose a REST API with with is
possible to handle SFCs. Despite other components of this implementation 
