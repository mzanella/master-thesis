...
least 3 hops (ingress, VNF, egress), so the packet must be elaborated by 3
different running software. Another interpretation lays into how the code was
written: components of this framework are not developed for production
...
every implementation, even whether more efficient than ours.
...
container can crash and can be recreated and be operative again. 
...
disabling all caching of the DNS of Pods) with the configuration and shown in
