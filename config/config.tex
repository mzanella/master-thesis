...
\newcommand{\myTitle}{A Lightweight, Container-based approach to Service function chaining }                                 % tipo di tesi
...
%pdfstartview=FitV,
    ...
    %nesting=true,
    %frenchlinks,
    urlcolor=linkgrey,%webbrown,
    linkcolor=linkgrey,%webbrown,
    citecolor=linkgrey,%webgreen,
    %pagecolor=RoyalBlue,
...
\titleformat{\chapter}[display]
  ...
  {\flushright\normalsize \color{linkgrey}%\color{Pantone}%
